...
{{--        </style>--}}
    ...
    <form action="store" method="post">
        <table border="1" align="center">
            ...
            <tr>
                <td>狗狗名稱</td><td><input type="text" name="name" id="name" /></td>
            </tr>
            <tr>
{{--                <td>體型編號</td><td><input type="text" name="somatotype_id" id="somatotype_id" /></td>--}}
                <td>體型編號</td>
                <td>
            ...
            <tr>
                <td>原產地</td><td><input type="text" name="source" id="source" /></td>
            </tr>
            <tr>
                <td>平均壽命</td><td><input type="text" name="avg_life" id="avg_life" /></td>
            </tr>
            <tr>
